        ...
        <footer className="bg-gradient-to-r from-gray-100 via-[#bce1ff] to-gray-100">
            <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        <img src="https://dk3677u7g8wfc.cloudfront.net/assets/img/logo-en.png" className="mr-5 h-6 sm:h-9" alt="logo" />
                        <p className="max-w-xs mt-4 text-sm text-gray-600">
                            Explore top football players and place your bids to own them. Win exciting auctions and build your dream team.
                        </p>
                    ...
                    <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
                        <div>
                            ...
                            <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
                                ...
                                <a className="hover:opacity-75" href> Fixtures </a>
                                <a className="hover:opacity-75" href> Statistics </a>
                            </nav>
                        </div>
                        <div>
                            <p className="font-medium">
                            ...
                            <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
                                <a className="hover:opacity-75" href> 1on1 Consulting </a>
